var data_a1e2fb4a_e986_4524_b0da_9b7ba7c0874d = 
{
	...
	"firstData": {
		...
		"startText": [
			...
			"数百年前魔物们为了对抗实力强横的人类势力，在初代魔王zone的带领下修筑了一座高耸入云的通天塔，这便是魔塔的雏形。",
			"残存的魔物们在魔塔里修筑了无数的迷宫跟陷阱，人类军队对这种情况束手无策，但战况却并没有因此向魔王zone倾倒。",
			"随着时间的推移，魔塔外的魔物几乎被人类消灭殆尽，人类在魔塔周围驻扎营地，建立防御措施。塔内残存的魔物们已是强弩之末，无力抵抗。",
			"初代魔王zone也在塔顶郁郁而终，人类与魔物长达十六年的战争至此就告一段落了。",
			"作为这次战争见证者的魔塔则被保留了下来，成为了该地区极有名气的古遗迹。",
			"安居乐业的人们却不知残存的魔物在魔塔里繁衍生息，重整实力......",
			"直到有一天，本国直系公主在18岁诞辰那夜被魔物们掳走，关押在暗无天日的魔塔顶端。",
			"原以为已经被彻底灭绝的魔物们竟然以魔塔为据点，向人类吹响了发起反攻的号角。",
			"为了避免公主被掳走一事的风声走漏到邻国，造成不必要的政治影响。",
			"贤明的君主决定派遣一支训练有素的勇者部队，不动声色地探索魔塔。",
			"时隔数百年，勇者斗恶龙这般老掉牙的戏码，就要从这里开始重新上演了......"
		],
		"shops": [],
		"levelUp": [
			{
	...
	"values": {
		"silverSwordDamageReduceEnemies": [
			"bat",
			"bigBat",
			"redBat",
			"vampire",
